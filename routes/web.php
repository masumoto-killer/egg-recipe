...
Route::put('/user/set-mail-notification', [UserController::class, 'setEmailNotification'])->name('set-mail-notification');
Route::post('/user/send-email', [UserController::class, "testSendEmail"])->name('test.email');
